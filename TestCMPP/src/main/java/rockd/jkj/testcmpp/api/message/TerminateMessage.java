 ...
 * @version $Id: TerminateMessage.java,v 0.2 2007/05/15 13:45:29 
 */
public class TerminateMessage extends AbstractMessage
{
	private static final long serialVersionUID = CommandID.CMPP_TERMINATE;


	public TerminateMessage()
	{
		commandId = CommandID.CMPP_TERMINATE;
	}
