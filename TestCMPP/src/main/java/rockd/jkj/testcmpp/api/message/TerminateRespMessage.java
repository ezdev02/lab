 ...
 * @version $Id: TerminateRespMessage.java,v 0.2 2007/05/15 13:45:29 
 */
public class TerminateRespMessage extends AbstractMessage
{
	private static final long serialVersionUID = CommandID.CMPP_TERMINATE_RESP;


	public TerminateRespMessage()
	{
		commandId = CommandID.CMPP_TERMINATE_RESP;
	}
