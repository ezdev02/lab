 ...
 * @version $Id: ActiveTestMessage.java,v 0.2 2007/05/15 13:45:29 
 */
public class ActiveTestMessage extends AbstractMessage
{
	private static final long serialVersionUID = CommandID.CMPP_ACTVIE_TEST;


	public ActiveTestMessage()
	{
		commandId = CommandID.CMPP_ACTVIE_TEST;
	}
